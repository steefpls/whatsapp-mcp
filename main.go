...
func main() {
	...
	if claudeConfig.Enabled {
		...
		trigger := claude.NewTrigger(claudeConfig, waClient.SendTextMessage, waClient.SendTextMessageWithID, waClient.RevokeMessage, waClient.EditMessage, store.GetChatMessagesWithNames, trustedUserStore.IsTrusted, store, mediaStore, sessionMgr)
