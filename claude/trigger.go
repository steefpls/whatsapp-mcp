...
func (t *Trigger) buildPrompt(chatJID string, messages []storage.MessageWithNames, triggerText, senderName string, isOwner bool) string {
	...
	b.WriteString("IMPORTANT: Do NOT end your response with any sign-off, signature, name, or closing attribution (no \"— Claude\", \"Cheers, Claude\", \"— C\", \"Best,\", \"@claude out\", etc.). An attribution line is automatically appended for you by the system — if you add your own too, the user sees two sign-offs. Just end on your actual last sentence.\n")
